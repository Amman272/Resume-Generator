...
const ResumeBuilder = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    endDate_1: "July 2022",
    experiencePoint1_1:
      "Built a dashboard for internal analytics using React and Node.js",
    experiencePoint2_1:
      "Optimized API responses by 30% with caching mechanisms",
    experiencePoint3_1:
      "Collaborated with a team of 6 engineers using Agile practices",
    ...
    experiencePoint3_2:
      "Mentored 2 interns on backend development best practices",
    ...
    projectDate_2: "2023",
    projectPoint1_2:
      "Developed full-stack shopping platform with cart and checkout",
    ...
    achievementPoint_1:
      "Won 1st prize for developing a smart health monitoring app",
  ...
  async function sendBack() {
    ...
    try {
      ...
      setError(
        "Failed to generate resume. Please ensure the backend server is running."
      );
    } finally {
      setIsLoading(false);
    }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              <Link
                to="/"
                className="flex items-center space-x-2 text-muted-foreground hover:text-primary transition-colors px-3 py-2 rounded-lg hover:bg-secondary"
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("educationLocation", e.target.value)
                      }
                  ...
                  <div className="border border-border rounded-lg p-4 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleInputChange("companyName_1", e.target.value)
                          }
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleInputChange("role_1", e.target.value)
                        }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleInputChange("startDate_1", e.target.value)
                          }
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleInputChange("endDate_1", e.target.value)
                          }
                          placeholder="Present"
                        />
                      </div>
                    ...
                    <div className="space-y-3">
                      <div>
                        <Label htmlFor="experiencePoint1_1">
                          Experience Point 1
                        </Label>
                        <Textarea
                      ...
                      <div>
                        <Label htmlFor="experiencePoint2_1">
                          Experience Point 2
                        </Label>
                        <Textarea
                      ...
                      <div>
                        <Label htmlFor="experiencePoint3_1">
                          Experience Point 3
                        </Label>
                        <Textarea
                  ...
                  <div className="border border-border rounded-lg p-4 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleInputChange("companyName_2", e.target.value)
                          }
                          placeholder="Tech Company Inc."
                        />
                      </div>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleInputChange("role_2", e.target.value)
                        }
                        placeholder="Software Engineer"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleInputChange("startDate_2", e.target.value)
                          }
                          placeholder="January 2022"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleInputChange("endDate_2", e.target.value)
                          }
                          placeholder="Present"
                        />
                      </div>
                    ...
                    <div className="space-y-3">
                      <div>
                        <Label htmlFor="experiencePoint1_2">
                          Experience Point 1
                        </Label>
                        <Textarea
                      ...
                      <div>
                        <Label htmlFor="experiencePoint2_2">
                          Experience Point 2
                        </Label>
                        <Textarea
                      ...
                      <div>
                        <Label htmlFor="experiencePoint3_2">
                          Experience Point 3
                        </Label>
                        <Textarea
                  ...
                  <div className="border border-border rounded-lg p-4 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleInputChange("companyName_3", e.target.value)
                          }
                          placeholder="Tech Company Inc."
                        />
                      </div>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleInputChange("role_3", e.target.value)
                        }
                        placeholder="Software Engineer"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleInputChange("startDate_3", e.target.value)
                          }
                          placeholder="January 2022"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleInputChange("endDate_3", e.target.value)
                          }
                          placeholder="Present"
                        />
                      </div>
                    ...
                    <div className="space-y-3">
                      <div>
                        <Label htmlFor="experiencePoint1_3">
                          Experience Point 1
                        </Label>
                        <Textarea
                      ...
                      <div>
                        <Label htmlFor="experiencePoint2_3">
                          Experience Point 2
                        </Label>
                        <Textarea
                      ...
                      <div>
                        <Label htmlFor="experiencePoint3_3">
                          Experience Point 3
                        </Label>
                        <Textarea
                  ...
                  <div className="border border-border rounded-lg p-4 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleInputChange("projectName_1", e.target.value)
                          }
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleInputChange("projectDate_1", e.target.value)
                          }
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleInputChange("technologies_1", e.target.value)
                        }
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <Textarea
                          ...
                          onChange={(e) =>
                            handleInputChange("projectPoint1_1", e.target.value)
                          }
                      ...
                      <div>
                        ...
                        <Textarea
                          ...
                          onChange={(e) =>
                            handleInputChange("projectPoint2_1", e.target.value)
                          }
                      ...
                      <div>
                        ...
                        <Textarea
                          ...
                          onChange={(e) =>
                            handleInputChange("projectPoint3_1", e.target.value)
                          }
                  ...
                  <div className="border border-border rounded-lg p-4 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleInputChange("projectName_2", e.target.value)
                          }
                          placeholder="E-commerce Platform"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleInputChange("projectDate_2", e.target.value)
                          }
                          placeholder="March 2023"
                        />
                      </div>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleInputChange("technologies_2", e.target.value)
                        }
                        placeholder="React, Node.js, MongoDB"
                      />
                    </div>
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <Textarea
                          ...
                          onChange={(e) =>
                            handleInputChange("projectPoint1_2", e.target.value)
                          }
                          placeholder="Project point 1..."
                          rows={2}
                        />
                      ...
                      <div>
                        ...
                        <Textarea
                          ...
                          onChange={(e) =>
                            handleInputChange("projectPoint2_2", e.target.value)
                          }
                          placeholder="Project point 2..."
                          rows={2}
                        />
                      ...
                      <div>
                        ...
                        <Textarea
                          ...
                          onChange={(e) =>
                            handleInputChange("projectPoint3_2", e.target.value)
                          }
                          placeholder="Project point 3..."
                          rows={2}
                        />
                  ...
                  <div className="border border-border rounded-lg p-4 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleInputChange("projectName_3", e.target.value)
                          }
                          placeholder="E-commerce Platform"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleInputChange("projectDate_3", e.target.value)
                          }
                          placeholder="March 2023"
                        />
                      </div>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleInputChange("technologies_3", e.target.value)
                        }
                        placeholder="React, Node.js, MongoDB"
                      />
                    </div>
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <Textarea
                          ...
                          onChange={(e) =>
                            handleInputChange("projectPoint1_3", e.target.value)
                          }
                          placeholder="Project point 1..."
                          rows={2}
                        />
                      ...
                      <div>
                        ...
                        <Textarea
                          ...
                          onChange={(e) =>
                            handleInputChange("projectPoint2_3", e.target.value)
                          }
                          placeholder="Project point 2..."
                          rows={2}
                        />
                      ...
                      <div>
                        ...
                        <Textarea
                          ...
                          onChange={(e) =>
                            handleInputChange("projectPoint3_3", e.target.value)
                          }
                          placeholder="Project point 3..."
                          rows={2}
                        />
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("developerTools", e.target.value)
                    }
                    placeholder="Git, Docker, VS Code, Postman"
                  />
                </div>
                <div>
                  <Label htmlFor="technologiesFrameworks">
              ...
              <div className="space-y-6">
                ...
                {visibleSections.achievement_1 && (
                  <div className="border border-border rounded-lg p-4 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="organizationName_1">
                          Organization Name
                        </Label>
                        <Input
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="achievementStartDate_1">
                          Start Date
                        </Label>
                        <Input
                    ...
                    <div>
                      <Label htmlFor="achievementPoint_1">
                        Achievement Point
                      </Label>
                      <Textarea
                ...
                {visibleSections.achievement_2 && (
                  <div className="border border-border rounded-lg p-4 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="organizationName_2">
                          Organization Name
                        </Label>
                        <Input
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="achievementStartDate_2">
                          Start Date
                        </Label>
                        <Input
                    ...
                    <div>
                      <Label htmlFor="achievementPoint_2">
                        Achievement Point
                      </Label>
                      <Textarea
                ...
                {visibleSections.achievement_3 && (
                  <div className="border border-border rounded-lg p-4 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="organizationName_3">
                          Organization Name
                        </Label>
                        <Input
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="achievementStartDate_3">
                          Start Date
                        </Label>
                        <Input
                    ...
                    <div>
                      <Label htmlFor="achievementPoint_3">
                        Achievement Point
                      </Label>
                      <Textarea
